...
\begin{figure}[h]
	...
	\end{center}
	\caption{Loss Function = $\sum_{i = 1}^{n} \abs{y_i - f(x_i)}$ (L1 loss), Epochs = 1000, Learning Rate = 0.02, Training Error = 0.321, Testing Error = 0.373}
	\label{fig:l1loss}
\end{figure}
...
\begin{figure}[h]
	...
	\end{center}
	\caption{Loss Function = $\sum_{i = 1}^{n} (y_i - f(x_i))^2$ (L2 loss), Epochs = 1000, Learning Rate = 0.02, Training Error = 0.271, Testing Error = 0.276}
	\label{fig:l2loss}
\end{figure}
